...
description: 'Teknik sparse retrieval dengan learned term expansions.'
pubDate: '2026-07-27'
...
Generate sparse embedding: non-zero di terms yang relevan. More interpretable dan exact-matchable.

## SPLADE++

Improved training dengan distillation. Faster inference.

## Hybrid with Dense

Combine sparse untuk keyword matching, dense untuk semantic. Complement each other.
## FAQ
