---
title: 'Agent Memory Persistence dan Storage Patterns'
description: 'Menyimpan dan retrieving agent memory di production.'
pubDate: '2026-07-27'
...
PostgreSQL untuk structured, Redis untuk cache, Vector DB untuk semantic memory.

## TTL policies

Ephemeral memory: 24h. Session memory: 7 days. Persistent memory: indefinite.

## Privacy

GDPR: user can request memory deletion. Implement soft-delete with retention policy.
## FAQ
