---
title: 'Distributed Agent Coordination pada Kubernetes'
description: 'Mengorkestrasi agent di cluster Kubernetes untuk scalable automation.'
pubDate: '2026-07-27'
...
Setiap agent deploy sebagai separate deployment atau Job. API Gateway route berdasarkan task type.

## State Management

Shared state di Redis atau etcd. Agent coordination via consensus protocol.

## Autoscaling

HPA based on task queue depth. KEDA untuk event-driven scaling.
## FAQ
...
- [Kubernetes Patterns](https://kubernetes.io/docs/concepts/patterns/)
---
