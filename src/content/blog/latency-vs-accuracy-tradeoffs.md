---
title: 'Latency vs Accuracy Trade-offs dalam AI Systems'
description: 'Mengoptimalkan trade-off antara response speed dan output quality.'
pubDate: '2026-07-27'
...
Return token-by-token. TTFB rendah, perceived latency rendah. Output quality sama.

## Early Stopping

Jika LLM confidence tinggi sebelum full generation, stop early. Risiko: incomplete answer.

## Model Tiers

Fast model untuk high-confidence, slow model untuk complex. Router decide.
## FAQ
