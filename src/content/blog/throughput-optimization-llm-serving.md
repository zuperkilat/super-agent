---
title: 'Throughput Optimization untuk LLM Serving'
description: 'Strategi maximizing throughput tanpa sacrifice latency.'
pubDate: '2026-07-27'
...
vLLM approach: add request ke batch saat slot kosong, bukan wait all finish. Throughput 2-4x.

## Speculative Decoding

Draft model propose tokens, target verify. 2x speedup.

## KV Cache Sharing

For similar prompts, reuse KV cache computation.
## FAQ
...
- [vLLM Throughput](https://docs.vllm.ai/en/latest/)
---
