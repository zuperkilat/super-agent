---
title: 'LLM Cost Optimization Playbook 2026'
...
Kurangi token dengan: removing filler, structured output, shorter system prompt. Target 20-40% reduction.

## Model Tiers

Tier 1: Haiku/Mini untuk routing. Tier 2: Sonnet untuk reasoning. Tier 3: Opus untuk complex only.

## Batch Processing

Kumpulkan requests, process di off-peak. Provider batch API untuk 50% discount.
## FAQ
