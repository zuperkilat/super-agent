---
title: 'Reward Model Training untuk RLHF Pipeline'
description: 'Panduan training reward model yang robust untuk human preferences.'
pubDate: '2026-07-27'
...
Collect pairwise comparisons. Same prompt, two responses, human label best and worst.

## Training

Fine-tune classifier atau regression head pada ranked pairs. Output scalar reward.

## Evaluation

Compute accuracy against held-out human rankings. Target >85%.
## FAQ
