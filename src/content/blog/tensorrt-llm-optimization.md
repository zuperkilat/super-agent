---
title: 'TensorRT-LLM: NVIDIA Inference Optimization'
description: 'Optimasi LLM inference dengan TensorRT untuk NVIDIA GPU.'
pubDate: '2026-07-27'
...
Fused attention, GEMM kernels, FP8 quantization. Support LLaMA, Mistral, Falcon.

## Building Engine

Build optimized engine dari ONNX atau HuggingFace checkpoint. Cache engine untuk reuse.

## Performance Gain

2-4x faster daripada PyTorch inference. Latency p10 bisa turun 50-70%.
## FAQ
