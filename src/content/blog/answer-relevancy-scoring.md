---
title: 'Answer Relevancy Scoring untuk RAG Evaluasi'
description: 'Cara mengukur seberapa relevan LLM answer dengan original question.'
pubDate: '2026-07-27'
...
Compute cosine similarity antara question embedding dan answer embedding.

## LLM-as-Judge

LLM evaluator score relevancy 1-5. Lebih akurat tapi lebih mahal.

## Composite Score

Gabungkan embedding similarity dan LLM judgment. Weighted average.
## FAQ
...
- [RAGAS Answer Relevancy](https://docs.ragas.io/en/latest/concepts/metrics/)
---
