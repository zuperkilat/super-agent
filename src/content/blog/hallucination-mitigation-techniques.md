---
title: 'Hallucination Mitigation Techniques untuk LLM'
description: 'Strategi mengurangi fabricated content dalam LLM output.'
pubDate: '2026-07-27'
...
Force LLM cite sources. Retrieval-augmented generation dengan strict citations.

## Self-Verification

LLM generate answer, then verify against source. Confidence score dari verification step.

## Post-Processing

Fact-check dengan knowledge base or external API. Flag atau mask low-confidence claims.
## FAQ
...
- [Mitigating Hallucinations](https://arxiv.org/abs/2312.01571)
---
