---
title: 'Data Center Design untuk AI Inference'
description: 'Arsitektur data center yang optimal untuk serving LLM pada skala.'
pubDate: '2026-07-27'
...
NVIDIA HGX H100, AMD MI300X. Interconnect: NVLink, InfiniBand. Topology: fat-tree.

## Power dan Cooling

1000W+ per GPU. Liquid cooling mandatory untuk dense clusters.

## Stage Inference vs Training

Inference clusters: lebih sedikit GPU, lebih banyak CPUs untuk request handling. Auto-scaling berdasarkan queue depth.
## FAQ
...
- [NVIDIA AI Infrastructure](https://www.nvidia.com/en-us/data-center/hgx/)
---
