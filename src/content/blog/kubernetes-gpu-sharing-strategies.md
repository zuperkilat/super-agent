---
title: 'Kubernetes GPU Sharing untuk LLM Serving'
description: 'Strategi sharing GPU di Kubernetes untuk optimize resource utilization.'
pubDate: '2026-07-27'
...
Split H100 menjadi 7 instances. Setiap instance punya isolated memory dan compute.

## MPS (Multi-Process Service)

Multiple processes share single GPU. Lebih efisient daripada time-slicing.

## Orchestration

Use NVIDIA device plugin. Set resource requests: nvidia.com/gpu: 1. Orchestration di layer node.
## FAQ
