---
title: 'Context Precision dan Recall dalam RAG'
description: 'Memahami context precision dan recall untuk RAG system optimization.'
pubDate: '2026-07-27'
...
Jumlah retrieved chunk yang relevant dibagi total retrieved. Tinggi berarti retrieval accurate.

## Context Recall

Jumlah relevant chunk yang di-retrieve dibagi total relevant yang ada. Tinggi berarti tidak miss information.

## Target

Production: Precision > 80%, Recall > 70%. Tergantung data distribution.
## FAQ
