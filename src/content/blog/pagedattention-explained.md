---
title: 'PagedAttention: Revolutionizing LLM Inference'
description: 'Memahami PagedAttention, teknologi inti di balik vLLM yang meningkatkan throughput hingga 24x.'
pubDate: '2026-07-27'
heroImage: '../../assets/blog-placeholder-5.jpg'
---

## Masalah KV Cache Fragmentation

KV cache sebelumnya dialokasikan contiguous memory. Fragmen terjadi karena variable sequence length. Waste 60-80% memory dalam production.

## PagedAttention Solution

Memecah KV cache menjadi blocks, seperti virtual memory paging. Block dialokasikan on-demand, bisa sharing antar sequences. Tidak ada waste.

## Continuous Batching

PagedAttention memungkinkan continuous batching: tambah request ke batch saat ada slot kosong, bukan tunggu semua request selesai. Throughput meningkat drastis.
## FAQ
