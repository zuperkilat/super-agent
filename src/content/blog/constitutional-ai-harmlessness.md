---
title: 'Constitutional AI: Harmlessness dari AI Feedback'
description: 'Prinsip Constitutional AI untuk membuat LLM yang helpful dan harmless.'
pubDate: '2026-07-27'
...
LLM diberikan constitution, lalu generate response, self-critique terhadap constitution, and revise. Proses ini diulang sampai output aligned.

## RLAIF (RL from AI Feedback)

Gunakan AI sebagai evaluator instead of human. Lebih scalable tapi quality bergantung pada AI evaluator capability.

## Constitutional Principles

Contoh principles: jangan discriminate berdasarkan protected attributes, protect privacy, avoid toxicity, refuse harmful requests.
## FAQ
