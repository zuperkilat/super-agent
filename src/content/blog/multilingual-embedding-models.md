---
title: 'Multilingual Embedding Models untuk Global Apps'
description: 'Membangun RAG systems yang support multiple languages.'
pubDate: '2026-07-27'
...
E5, BGE-M3, Cohere multilingue, Jina. Support 100+ languages.

## Challenge

Cross-lingual retrieval: query in one language, docs in another. Multilingual embeddings solve this.

## Evaluation

XTREME, MKQA benchmarks. Cross-lingual transfer learning.
## FAQ
