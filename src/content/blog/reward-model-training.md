---
title: 'Reward Model Training untuk RLHF'
description: 'Mengembangkan reward model yang akurat untuk human preferences.'
pubDate: '2026-07-27'
...
Collect comparison pairs: same prompt, two responses, human label best dan worst.

## Model Choice

Fine-tune LLM classifier atau regression head. Output reward score [-inf, inf].

## Evaluation

Compute accuracy: berapa persen reward model agree dengan human ranking.
## FAQ
...
- [OpenAI WebGPT](https://openai.com/research/webgpt)
---
