---
title: 'Tracing Agent Execution dengan LangGraph'
description: 'Mendebug dan monitor agentic workflows menggunakan built-in LangGraph tracing.'
pubDate: '2026-07-27'
...
Setiap node execution di-record: input, output, latency. Trace dapat di-inspect di LangSmith atau console.

## Custom Metadata

Tambahkan metadata: user_id, session_id, model version. Berguna untuk debugging production issues.

## Step-Level Retry

Inspect trace, identify failed step, retry hanya step tersebut instead of full workflow.
## FAQ
