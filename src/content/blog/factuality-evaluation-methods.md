---
title: 'Factuality Evaluation Methods untuk LLM Outputs'
description: 'Metodologi evaluasi apakah LLM output sesuai dengan ground truth.'
pubDate: '2026-07-27'
...
FActScore: decompose claim, verify against knowledge base. Claim-level precision dan recall.

## Human Evaluation

Expert review untuk domain-specific tasks. Inter-annotator agreement measurement.

## Benchmarking

Auto-BIO, BioGEN, FEVER. Factuality ad becoming standard eval alongside accuracy.
## FAQ
