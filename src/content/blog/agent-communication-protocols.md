---
title: 'Agent Communication Protocols: A2A, ACP'
description: 'Membandingkan protocol komunikasi antar agent.'
pubDate: '2026-07-27'
...
Lightweight protocol untuk message passing. HTTP-based dengan JSON payload.

## ACP (Agent Communication Protocol)

Structured dengan schema validation. Support streaming dan backpressure.

## Comparison

A2A untuk simple coordination. ACP untuk complex data exchange. MCP untuk tool invocation.
## FAQ
...
- [A2A Protocol](https://agents.json/)
---
