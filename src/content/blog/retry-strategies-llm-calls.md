---
title: 'Retry Strategies untuk LLM API Calls'
description: 'Mengelola retry untuk nondeterministic errors pada LLM APIs.'
pubDate: '2026-07-27'
...
Retryable: 429, 502, 503, 504. Non-retryable: 400, 401, 403, 404.

## Exponential Backoff

Base 1s, multiplier 2, max 60s. Jitter 0-30% untuk avoid thundering herd.

## Mutex untuk Distributed Systems

Redis distributed lock. Only one instance retry at a time.
## FAQ
